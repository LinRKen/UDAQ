...
def get_config():
    config = {
        ...
        "optimizer": {"type": optim.SGD, "epoch_lr_decrease": 50,
                      "optim_params": {"lr": 1e-3, "weight_decay": 5e-4, "momentum": 0.9}},
        ...
        "bit_list": [64],
        'save_path': './models/UBH/DomainNet',
...
def val(config,bit):
    ...
    model_path = './models/UBH/DomainNet/DomainNet_real_real-0.1651074224224114-model.pt'
