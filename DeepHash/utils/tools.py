...
def config_dataset(config):
    ...
    if config["dataset"] == "DomainNet":
        config["data_path"] = "/mnt/hdd1/zhangzhibin/dataset/DomainNet/"
    if config["dataset"] == "OfficeHome":
        config["data_path"] = "/mnt/hdd1/zhangzhibin/dataset/OfficeHome/"
    ...
    if config["dataset"] == "DomainNet":
        ...
        if config['Flag_supervised']:
            config["data"] = {
            "train_set": {"list_path": root_dir+config['seen_domain']+'_train.txt', "batch_size": config["batch_size"]},
            "database": {"list_path": root_dir+config['seen_domain']+'_train.txt' , "batch_size": config["batch_size"]},
            "test": {"list_path": root_dir+config['unseen_domain']+'_test.txt', "batch_size": config["batch_size"]}}
        else:
            config["data"] = {
            "train_set": {"list_path": root_dir+config['seen_domain']+'_'+config['unseen_domain']+'_train.txt', "batch_size": config["batch_size"]},
            "database": {"list_path": root_dir+config['seen_domain']+'_train.txt' , "batch_size": config["batch_size"]},
            "test": {"list_path": root_dir+config['unseen_domain']+'_test.txt', "batch_size": config["batch_size"]}}
    ...
    if config["dataset"] == "OfficeHome":
        ...
        if config['Flag_supervised']:
            config["data"] = {
            "train_set": {"list_path": root_dir+config['seen_domain']+'_all.txt', "batch_size": config["batch_size"]},
            "database": {"list_path": root_dir+config['seen_domain']+'_all.txt' , "batch_size": config["batch_size"]},
            "test": {"list_path": root_dir+config['unseen_domain']+'_test.txt', "batch_size": config["batch_size"]}}
        else:
            config["data"] = {
            "train_set": {"list_path": root_dir+config['seen_domain']+'_'+config['unseen_domain']+'_train.txt', "batch_size": config["batch_size"]},
