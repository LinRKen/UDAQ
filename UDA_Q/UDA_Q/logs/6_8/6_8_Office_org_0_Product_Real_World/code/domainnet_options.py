...
class Options:
    ...
    def __init__(self):
        ...
        parser.add_argument('-data', '--dataset', default='DomainNet', choices=['MNIST_USPS','OfficeHome', 'DomainNet'])
        ...
        parser.add_argument('-sd', '--seen_domain', default='real')
        parser.add_argument('-ud', '--unseen_domain', default='quickdraw')
        ...
        parser.add_argument('-dim','--dim', type=int, default=512)
        parser.add_argument('-cls_gamma','--cls_gamma', type=float, default=0.7)
        parser.add_argument('-trust_gamma','--trust_gamma', type=float, default=2)
        parser.add_argument('-weight_decay','--weight_decay', type=float, default=0)
        parser.add_argument('-Q_weight_decay','--Q_weight_decay', type=float, default=0)

        parser.add_argument('-reg_rate','--reg_rate', type=float, default=0)
