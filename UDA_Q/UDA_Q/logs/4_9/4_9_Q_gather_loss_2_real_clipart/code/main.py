...
if __name__ == '__main__':
    ...
    for epoch in range(n_train):
        ...
        mean_loss = train_source( epoch , core ,train_loader1, backbone, [optimizer,Q_optimizer],quantizer,logger )

        if epoch >= epoch_warmup:
            mean_loss += train_T_sample( epoch , core ,train_loader,S_train_set, backbone, [optimizer,Q_optimizer] , quantizer,logger )
