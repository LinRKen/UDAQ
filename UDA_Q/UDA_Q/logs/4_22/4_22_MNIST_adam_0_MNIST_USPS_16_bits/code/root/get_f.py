...
if __name__ == '__main__':	
	...
	if dataset == 'DomainNet':
		...
		for name in ['all','train','query','gallery']:
			...
			img_loader = DataLoader(dataset, batch_size=64, shuffle=False, num_workers=4)
			path = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/MNIST_USPS/MNIST_no_crop/'
		...
		for name in ['all','train','query','gallery']:
			...
			img_loader = DataLoader(dataset, batch_size=64, shuffle=False, num_workers=4)
			path = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/MNIST_USPS/USPS_no_crop/'
			extract_feature(img_loader,model,path+name)