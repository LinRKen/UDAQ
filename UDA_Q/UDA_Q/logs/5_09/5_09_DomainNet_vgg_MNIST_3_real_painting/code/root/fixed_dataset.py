...
def load_dataset_from_npy(file_dir):
    f_train = np.load(file_dir+'_feature.npy')
    label_train = np.load(file_dir+'_label.npy')
    dataset = fixed_dataset(f_train,label_train)
    return dataset
...
def split_DomainNet(domain_name):
    ...
    # train_set = load_dataset_from_npy(root_dir+domain_name+'_train/'+domain_name+'_train')
    # val_set = load_dataset_from_npy(root_dir+domain_name+'_train/'+domain_name+'_train')

    # /home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/domainnet_vgg_MNIST/real/test_feature.npy
    root_dir = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/domainnet_vgg_MNIST/'
    train_set = load_dataset_from_npy(root_dir+domain_name+'/'+'train')
    val_set = load_dataset_from_npy(root_dir+domain_name+'/'+'test')
...
def split_OfficeHome(domain_name):
    ...
    root_dir = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/OfficeHome_resplit/'
    # root_dir = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/OfficeHome_vgg_MNIST/'
    datasets = {}
    ...
    return datasets['train'],datasets['test'],datasets['all']
...
def get_MNIST_USPS():    
    ...
    # dir = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/MNIST_USPS_new/MNIST/'
    for s in ['MNIST all','MNIST test','USPS train','USPS test']:
        domain, data_type = s.split()
        dir = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/MNIST_USPS_resplit/'+domain+'/'+data_type
        dataset = load_dataset_from_npy(dir)
    ...
    # dir = '/home/zhangzhibin/data/UDA/CDTrans-master/fixed_f/vgg/MNIST_USPS_new/USPS/'
