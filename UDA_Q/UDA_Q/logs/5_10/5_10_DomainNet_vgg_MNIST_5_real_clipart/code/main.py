...
# model_fc, model_vgg,model_AlexNet_single_head,model_S_T_fc,model_vgg_single_head
    ...
    if False:
        st_epoch = 100
        load_model_path = '/home/zhangzhibin/data/UDA/CDTrans-master/UDA_Q/logs/5_10/5_10_DomainNet_vgg_MNIST_3_real_clipart/model/5_10_DomainNet_vgg_MNIST_3_100.pth'
