from sqlalchemy import all_, true
import torch
import numpy as np
import random
...
def split_data_list_w_cls(query_cnt,train_cnt,all_list,n_class):
    import random
    random.seed(0)
...
def get_CIFAR10():
    ...
    if 'all_list.txt' not in list_files:
        import torchvision
        ...
        all_list_file =open(list_dir+'all_list.txt','w')
    ...
    if 'train_list.txt' not in list_files:
        ...
        n_class = 10
        query_list,train_list,gallery_list = split_data_list_w_cls(100,500,all_list,n_class)
...
def get_ImageNet():
    ...
    if 'train_list.txt' not in list_files:
        ...
        train_list,gallery_list,_ = split_data_list_w_cls(100,10000,gallery_list,n_select_class)
...
def get_img_dataset_2323(root_path,list_dir):
    from torchvision import transforms
    import torchvision
    ...
    query_set = ImageDataset(root_path,list_dir+'query_list.txt',val_transform)
    train_set = ImageDataset(root_path,list_dir+'train_list.txt',val_transform)
    gallery_set = ImageDataset(root_path,list_dir+'gallery_list.txt',val_transform)
    return train_set,query_set,gallery_set

def get_img_MNIST_USPS():
    root_path = '/mnt/hdd1/zhangzhibin/dataset/MNIST/'
    list_dir = '/mnt/hdd1/zhangzhibin/dataset/MNIST/'
    S_train_set, S_query_set, S_gallery_set = get_img_dataset_2323(root_path,list_dir)
    root_path = '/mnt/hdd1/zhangzhibin/dataset/USPS/'
    list_dir = '/mnt/hdd1/zhangzhibin/dataset/USPS/'
    T_train_set, T_query_set, T_gallery_set = get_img_dataset_2323(root_path,list_dir)
    return S_train_set, S_query_set, S_gallery_set, T_train_set, T_query_set, T_gallery_set