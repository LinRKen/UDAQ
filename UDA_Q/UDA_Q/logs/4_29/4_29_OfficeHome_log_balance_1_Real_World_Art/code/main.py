...
if __name__ == '__main__':
    ...
    if args.dataset == 'DomainNet':
        ...
        S_train_set, S_query_set, _ = split_OfficeHome(args.seen_domain)
...
# model_fc, model_vgg,model_AlexNet_single_head,model_S_T_fc,model_vgg_single_head
    if args.optimizer == 'sgd':
        ...
        S_optimizer = optim.Adam(backbone.parameters(), lr=args.lr,betas=(0.5,0.5))

    T_optimizer = S_optimizer

    # if type(backbone) in [model_fc,model_S_T_fc,model_fc_MNIST,model_refix_fc]:
    #     S_optimizer = optim.SGD(backbone.parameters(), lr=args.lr, momentum=0.9, nesterov=True)
    ...
    #     T_optimizer = S_optimizer
    S_scheduler = torch.optim.lr_scheduler.ExponentialLR(S_optimizer,gamma=0.99,)
    ...
    Q_optimizer = optim.Adam(quantizer.parameters(), lr=args.Q_lr,weight_decay=args.weight_decay)
