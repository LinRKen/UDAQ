...
def train_T_sample(S_train_loader,T_train_loader,S_train_set, backbone, list_optimizer , quantizer,logger ):
    mean_loss = Avg_er('mean_loss')
    ...
    with torch.no_grad():
        ...
        n_class = backbone.n_class
        
        code_memory = torch.LongTensor(n_class,2000,quantizer.n_quantizer ).cuda()
