...
if __name__ == '__main__':
    ...
    train_loader1 = DataLoader( S_train_set, batch_size=batch_size, shuffle=True,num_workers=8, pin_memory=True)

    train_loader2 = DataLoader( T_train_set, batch_size=batch_size, shuffle=True, num_workers=8,  pin_memory=True)
