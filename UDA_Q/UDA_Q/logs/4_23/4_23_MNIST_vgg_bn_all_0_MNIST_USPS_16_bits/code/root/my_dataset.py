...
def get_img_dataset(root_path,list_dir):
    from torchvision import transforms
    import torchvision
...
def get_img_MNIST_USPS():
    ...
    S_train_set, S_query_set, S_gallery_set = get_img_dataset(root_path,list_dir)
    root_path = '/mnt/hdd1/zhangzhibin/dataset/USPS/'
    list_dir = '/mnt/hdd1/zhangzhibin/dataset/USPS/'
    T_train_set, T_query_set, T_gallery_set = get_img_dataset(root_path,list_dir)
