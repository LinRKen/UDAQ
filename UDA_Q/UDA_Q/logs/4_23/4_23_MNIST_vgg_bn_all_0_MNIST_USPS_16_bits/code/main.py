...
# model_fc, model_vgg,model_AlexNet_single_head,model_S_T_fc,model_vgg_single_head
    if type(backbone) in [model_fc,model_S_T_fc,model_fc_cls,model_refix_fc]:
        ...
        # ,betas=(0.5,0.999))
    elif type(backbone) in [ model_AlexNet_single_head,model_vgg_single_head,model_vgg_bn_all ] :
        ...
        S_optimizer = optim.SGD(backbone.get_optim_lr(args.lr), momentum=0.9, nesterov=True)
        T_optimizer = S_optimizer
