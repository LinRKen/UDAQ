...
# model_fc, model_vgg,model_AlexNet_single_head,model_S_T_fc,model_vgg_single_head
    ...
    # T_scheduler = torch.optim.lr_scheduler.ExponentialLR(T_scheduler,gamma=0.95,)
    ...
    Q_scheduler = torch.optim.lr_scheduler.ExponentialLR(Q_optimizer,gamma=0.95,)
    ...
    for epoch in range(st_epoch,n_train+1):
        ...
        if epoch>= epoch_warmup:
            ...
            S_rate = 1
        S_loss = train_source(args, S_train_loader, backbone, [S_optimizer,Q_optimizer],quantizer,logger)
        # mean_loss = 0
