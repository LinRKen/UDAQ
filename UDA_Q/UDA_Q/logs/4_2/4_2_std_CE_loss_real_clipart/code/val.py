...
if __name__ == '__main__':
    ...
    print(S_train_set.__len__())
    print(S_query_set.__len__())
    print(S_gallery_set.__len__())

    print(T_train_set.__len__())
    print(T_query_set.__len__())
    print(T_gallery_set.__len__())
